      ...
      <Card className="overflow-hidden">
        <CardContent className="grid p-0 md:grid-cols-2 min-h-[500px]">
            ...
            <div className="flex flex-col gap-6 p-6 md:p-8">
              ...
              <div className="">
                <form action={auth}>
                <GeneralSubmitButton text="Continue with Google" icon={<GoogleIcon/>} variant="default" width="w-full"/>
                </form>
              </div>
              <div className="">
                <form action={githubAuth}>
                <GeneralSubmitButton text="Continue with Github" icon={<GithubIcon/>} variant="ghost" width="w-full"/>
                </form>
              </div>
